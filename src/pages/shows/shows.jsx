...
import { BsSearch, BsFilter, BsTv } from "react-icons/bs";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-text-secondary">Loading TV shows...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="text-center space-y-4">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <div className="w-12 h-12 bg-accent/20 rounded-xl flex items-center justify-center">
                <BsTv className="w-6 h-6 text-accent" />
              </div>
            ...
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Discover amazing TV series from around the world. Binge-watch your next favorite show.
            </p>
          </div>
        ...
        {showsList.length > 0 ? (
          ...
          >
            ...
            <div className="text-center">
              <p className="text-text-secondary">
                Found {showsList.length} {query ? 'search results' : 'popular TV shows'}
              </p>
            </div>
          ...
          >
            <div className="w-24 h-24 bg-accent/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <BsTv className="w-12 h-12 text-accent" />
            </div>
            <h3 className="text-2xl font-bold text-text mb-2">No TV shows found</h3>
            <p className="text-text-secondary">
              Try adjusting your search terms or browse our popular TV shows.
            </p>
          </motion.div>
        )}
      </div>
